...
CREATE TABLE `reusable_relation_strategies` (
  ...
  `strategy_source` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'scenario_inferred',
  `relation_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'same_value',
  `evidence_json` text COLLATE utf8mb4_unicode_ci,
